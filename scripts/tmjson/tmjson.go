...
//
// By default, both marshal and unmarshal implementations are generated.  Use
// the -m and -u flags to enable one or the other alone.
package main
...
var (
	...
	doMarshal   = flag.Bool("m", false, "Generate marshaler")
	doUnmarshal = flag.Bool("u", false, "Generate unmarshaler")
)
